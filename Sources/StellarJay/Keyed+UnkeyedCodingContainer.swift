//
//  Keyed+UnkeyedCodingContainer.swift
//  StellarJay
//
//  Created by Stadelman, Stan on 8/15/18.
//
//  All content in this file incoporated from
...
public extension KeyedDecodingContainer {
    /*
    public func decode(_ type: Array<Dictionary<String, Any>>.Type, forKey key: K) throws -> Array<Dictionary<String, Any>> {
